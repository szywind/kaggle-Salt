...
from keras.layers import Input, ZeroPadding2D, Dropout, Conv2D, Conv2DTranspose, LeakyReLU
...
def unet_densenet121(img_rows, img_cols, color_type, num_classes=1):
    # encode_model, layers = densenet121_model(img_rows, img_cols, color_type, dropout_rate=0.15)
    encode_model, layers = densenet121_model(img_rows, img_cols, color_type)
