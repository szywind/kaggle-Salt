...
from keras.layers import Input, Dense, Activation, Flatten, Conv2D, MaxPooling2D, AveragePooling2D, GlobalAveragePooling2D, \
    GlobalMaxPooling2D, BatchNormalization, ZeroPadding2D, Activation, Dropout, UpSampling2D, Conv2DTranspose, LeakyReLU
...
def resnet50_model(img_rows, img_cols, color_type=1, trainable=True):
    ...
    weights_path = '../imagenet_models/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
def unet_resnet50(img_rows, img_cols, color_type, num_classes=1):
    encode_model, layers = resnet50_model(img_rows, img_cols, color_type)
